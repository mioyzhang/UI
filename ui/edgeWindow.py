...
# Form implementation generated from reading ui file './ui/edgeWindow.ui'
#
...
class Ui_EdgeMainWindow(object):
    def setupUi(self, EdgeMainWindow):
        ...
        self.pushButton_set.clicked['bool'].connect(self.lineEdit_c_address.setEnabled)
        self.pushButton_set.clicked['bool'].connect(self.lineEdit_c_port.setEnabled)

...
class Ui_EdgeMainWindow(object):
    def setupUi(self, EdgeMainWindow):
        ...
        self.listWidget_messages = QtWidgets.QListWidget(self.groupBox_msg_list)
        ...
        self.label_e_address = QtWidgets.QLabel(self.groupBox_3)
        self.label_e_address.setText("")
        self.label_e_address.setObjectName("label_e_address")
        self.gridLayout_2.addWidget(self.label_e_address, 0, 1, 1, 1)
        self.label_10 = QtWidgets.QLabel(self.groupBox_3)
        self.label_10.setObjectName("label_10")
        self.gridLayout_2.addWidget(self.label_10, 1, 0, 1, 1)
        self.label_e_port = QtWidgets.QLabel(self.groupBox_3)
        self.label_e_port.setText("")
        self.label_e_port.setObjectName("label_e_port")
        self.gridLayout_2.addWidget(self.label_e_port, 1, 1, 1, 1)
        self.label_12 = QtWidgets.QLabel(self.groupBox_3)
        self.label_12.setObjectName("label_12")
        self.gridLayout_2.addWidget(self.label_12, 2, 0, 1, 1)
        self.label_e_status = QtWidgets.QLabel(self.groupBox_3)
        self.label_e_status.setText("")
        self.label_e_status.setObjectName("label_e_status")
        self.gridLayout_2.addWidget(self.label_e_status, 2, 1, 1, 1)
    ...
    def retranslateUi(self, EdgeMainWindow):
        ...
        self.pushButton_test2.setText(_translate("EdgeMainWindow", "test"))
